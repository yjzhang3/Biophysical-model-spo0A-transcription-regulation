function plot_areaerrorbar_wosim(real_data,real_data_std,mycolors)
...
%     hold on
    h = errorbar(2:9,real_data(:,i),real_data_std(:,i),'Marker','o','MarkerSize',7,'MarkerFaceColor',mycolors(i,:),'LineStyle','none','LineWidth',2.78,'Color',mycolors(i,:));
    hold on
%     alpha = 0.5;   
