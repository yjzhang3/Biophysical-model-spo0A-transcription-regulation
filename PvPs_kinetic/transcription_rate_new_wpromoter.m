function TR = transcription_rate_new_wpromoter(nbd,energyi,mut,TF_conc,RNAp_conc,group_array,vmax_array)
...
for oo = 1:length(final_config(:,1))
    ...
    curr_p = prob_per_config_new_wpromoter(nbd,config,energyi,mut,TF_conc,RNAp_conc);
